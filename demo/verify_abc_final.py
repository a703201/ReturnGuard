...
CASES = {
    "A": (
        os.path.join(UP, "live_mug_returned.png"),
        os.path.join(UP, "live_mug.png"),
        "陶瓷马克杯·品质承诺卡",
        "MUG-LIVE-A",
        99.0,
        "同款+瑕疵(咖啡渍+划痕)",
...
with open(
    os.path.join(os.path.dirname(__file__), "live_abc_final.json"), "w", encoding="utf-8"
) as f:
